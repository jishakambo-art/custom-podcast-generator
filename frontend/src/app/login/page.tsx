        ...
        <div className="bg-white rounded-lg shadow-sm border p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-700">
              Your personalized daily podcast from your favorite sources
            </p>
          </div>
          ...
          <p className="text-center text-sm text-gray-700 mt-6">
            By signing in, you agree to configure your daily podcast sources
            and generate personalized audio briefings.
          </p>
        </div>
      </div>
    </main>
